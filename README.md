...
![image](https://github.com/TimidZe/diffusion-models-learning/blob/main/IMG/generated_result_300.png)

Inference Result by the ema model trained for 300 epochs 
